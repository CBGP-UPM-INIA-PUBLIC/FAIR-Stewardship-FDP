...
docker-compose up -d
```
(NOTE: the 'cleanup.sh' script should only be run if you find your FDP is not allowing edits)
...
3.  Uncomment the "hitch" and "varnish" services in the docker-compose file
